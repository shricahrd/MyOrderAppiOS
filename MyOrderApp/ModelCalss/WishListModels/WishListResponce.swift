...
// MARK: - WishListResponce
struct WishListResponce: Codable {
    let status: Bool?
    let statusCode: Int?
    let message: String?
    let wishlistData: [WishlistDatum]?
...
// MARK: - WishlistDatum
struct WishlistDatum: Codable {
    let fldProductID: Int?
    let fldProductName: String?
    let fldColorID, fldSizeID, fldProductPrice, fldSpclPrice: Int?
    let defaultImage: String?
    let fldRatingCount, fldReviewCount: Int?
    let colorList, sizeList: [JSONAny]
    let price, spclPrice, fldTotalRating: Int?

    enum CodingKeys: String, CodingKey {
        case fldProductID = "fld_product_id"
        case fldProductName = "fld_product_name"
        case fldColorID = "fld_color_id"
        case fldSizeID = "fld_size_id"
        case fldProductPrice = "fld_product_price"
        case fldSpclPrice = "fld_spcl_price"
        case defaultImage = "default_image"
        case fldRatingCount = "fld_rating_count"
        case fldReviewCount = "fld_review_count"
        case colorList = "color_list"
        case sizeList = "size_list"
        case price

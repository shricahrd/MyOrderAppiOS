...
class RangeSliderTrackLayer: CALayer {
    ...
    override func draw(in ctx: CGContext) {
        ...
        let lowerValuePosition = CGFloat(slider.positionForValue(Double(slider.lowerValue)))
        let upperValuePosition = CGFloat(slider.positionForValue(Double(slider.upperValue)))
...
public class RangeSlider: UIControl {
    ...
    @IBInspectable public var maximumValue: Double = 2500 {
        willSet(newValue) {
    ...
    @IBInspectable public var lowerValue: Double = 10 {
        didSet {
    ...
    @IBInspectable public var upperValue: Double = 2000 {
        didSet {
